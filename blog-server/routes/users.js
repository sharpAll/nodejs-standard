...
router.post('/register', async (req, res, next) => {
  ...
  try {
    let user = await querySql('select nickname,head_img from user where username = ?', [username])
